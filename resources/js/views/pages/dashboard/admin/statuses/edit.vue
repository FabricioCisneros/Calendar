                ...
                <div class="mt-6 shadow sm:rounded-lg">
                    ...
                    <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                        <div class="md:col-span-1">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">{{ $t('Editar estatus') }}</h3>
                            <p class="mt-1 text-sm leading-5 text-gray-500">
                                {{ $t('Detalles del estatus y modificacion del nombre') }}.
                            </p>
                        </div>
...
export default {
    ...
    metaInfo() {
        return {
            title: this.$i18n.t('Editar Estatus')
        }
    },
    data() {
        return {
        ...
        saveStatus() {
            ...
            axios.put('api/dashboard/admin/statuses/' + self.$route.params.id, self.status).then(function () {
                ...
                self.$notify({
                    ...
                    text: self.$i18n.t('Datos actualizados con exito').toString(),
                    type: 'success'
                });
            }).catch(function () {
                self.loading = false;
