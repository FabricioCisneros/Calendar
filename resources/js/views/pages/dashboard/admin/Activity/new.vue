                    ...
                    <div class="bg-white md:grid md:grid-cols-3 md:gap-6 px-4 py-5 sm:p-6">
                        ...
                        <div class="mt-5 md:mt-0 md:col-span-2">
                            <div class="grid grid-cols-3 gap-6">
                                ...
                                <div class="col-span-3">
                                    <label class="block text-sm font-medium leading-5 text-gray-700" for="category">{{
                                        $t('Categoria que pertenece') }}</label>
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input-select id="status" v-model="activity.categoria_id" :options="categoryList"
...
export default {
    ...
    methods: {
        saveActivity() {
            const self = this;
            self.loading = true;
            console.log("id::",self.activity.categoria_id);
